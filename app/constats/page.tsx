...
const mockConstats = [
  ...
  },
  {
    ...
    date: "2024-01-14",
    time: "16:45",
    location: "Vieux-Port, Marseille 1er",
    clients: ["Antoine Bernard"],
    status: "draft",
    severity: "minor",
    vehicleCount: 1,
  ...
  },
  {
    ...
    clients: ["Isabelle Moreau", "Thomas Petit"],
    status: "closed",
    severity: "major",
    vehicleCount: 2,
  ...
  },
  {
    ...
    date: "2024-01-12",
    time: "18:00",
    location: "Cours Mirabeau, Aix-en-Provence",
    clients: ["Laurent Roux"],
    status: "pending",
    severity: "minor",
    vehicleCount: 1,
